					...
					>
						<ScrollView showsVerticalScrollIndicator={false}>
							...
							<Text className='text-slate-600 mb-6 leading-5'>
								Schedule moments to enjoy guilt-free. You
								deserve it! 💛
							</Text>
							...
							<View className='bg-indigo-50 rounded-2xl p-4 mb-6 border border-indigo-100'>
								<Text className='text-indigo-900 text-sm leading-5'>
									✨ You'll get a gentle reminder at{' '}
									{formatTime(date)} saying: "Today is your
									planned joy! Enjoy guilt-free, you deserve
									it."
								</Text>
							</View>
							...
							<TouchableOpacity
								...
								activeOpacity={0.8}
								className='bg-indigo-500 rounded-3xl p-5 mb-8'
								style={{
									shadowColor: '#6366f1',
