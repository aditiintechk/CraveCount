...
import { Brain, Shield, Flame, TrendingUp } from 'lucide-react-native';
import { useStore } from '../store/useStore';
import { useEffect } from 'react';
import Animated, { useSharedValue, useAnimatedStyle, withSpring } from 'react-native-reanimated';

export default function StreakCard() {
  const { willpowerPoints, getTreeLevel, getAwarenessCount, getResistedCount, getCurrentStreak, getResistanceRate } = useStore();
  ...
  return (
    <View className="mx-6 mb-6">
      ...
      >
        ...
        {/* Streaks & Stats Row - Without Best Streak */}
